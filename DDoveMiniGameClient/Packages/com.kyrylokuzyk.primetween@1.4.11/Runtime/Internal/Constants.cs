...
namespace PrimeTween {
    internal static class Constants {
        ...
        internal const string modificationIsNotAllowedError = "Animation has already been started, it's not allowed to modify it anymore.";
        ...
        internal const string nonMainThreadError = "PrimeTween doesn't support non-main thread usage.";
