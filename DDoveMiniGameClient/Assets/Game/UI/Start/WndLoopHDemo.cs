...
namespace Game.UI
{
    public partial class WndLoopHDemo : DDoveUIPanelBase<WndLoopHDemo>
    {
        public override string StageName => "Start";
        public override string PanelName => "WndLoopHDemo";
        ...
        protected override void OnOpen()
        {
            ...
            if (_list == null)
            {
                DDoveDebug.LogError("WndLoopHDemo", ("reason", "missing LoopList"));
                return;
            }
        ...
        T FindNode<T>(string name) where T : Component
        {
            ...
            if (component == null)
            {
                DDoveDebug.LogError("WndLoopHDemo", ("reason", "missing scene node"), ("name", name));
            }
